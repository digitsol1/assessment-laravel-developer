<h1 align="center">Assessment for Laravel Developer</h1>
...
For any questions regarding the exam please send inquiry to <a href="mailto:info@digitsol.co">info@digitsol.co</a> or HR.

**Output**: Examinee is expected to push branch or send an email with attachment to their output files (preferably a zip file). Alternatively, examinee can attach a link to their GitHub Repository, Google Drive, Dropbox, or any other storage service to download the output if the file is too large to be attached on email, or for other reason.
...
1. Start a project in Laravel latest
...
- **+1 point** - Style the pages using a preferred framework (e.g. bootstrap, tailwind, etc.).
...
<p align="center">
<small>Prepared for DigitSol Laravel Developer Applicants only.<br>Do not reproduce document elsewhere.</small>
</p>
